...
import com.HnM.qe.test.stepdefinition.web.Common_Web_SD;
...
public class SearchProductPO extends CommonActionHelper{
	...
	//@FindBy(xpath="(//input[@placeholder='nav-search-form'])[2]") 
	@FindBy(xpath="//input[@id='nav-search-form']")
	...
	@FindBy(xpath="(//div[@data-component='heroImage'])[2]") 
	...
	@FindBys({ @FindBy(xpath="//div[@data-auid='facetdrawer_drawer_Price_M']//ul[@class='css-1fgku7'")
	})	public List<WebElement> facet_Price_CheckBox_ListMobile;
	
	@FindBys({ @FindBy(xpath="//div[@data-auid='facetdrawer_drawer_Color_M']//ul[@class='css-1fgku7']")
	...
	@FindBys( {
		@FindBy(xpath="//i[@class='academyicon icon-checkbox-active']")
	} )
	public List<WebElement> chkbox_price_selected;


	@FindBys( {
		@FindBy(xpath="//i[@class='academyicon icon-checkbox-inactive']")
	} )
	...
	//=======================================================================
	@FindBy(xpath="//span[text()='Filters']") public WebElement btnFilterFlyoutMobile;

	@FindBy(xpath="(//div[@data-component='heroImage'])[2]") public WebElement imgHero_CLP;

	@FindBys( {
		@FindBy(xpath="//div[@data-auid='facetsModalContent_M']//i[@class='academyicon icon-plus']")
	} )
	public List<WebElement> filterIconPlusListMobile;

	@FindBys( {
		@FindBy(xpath="//div[@data-auid='facetsModalContent_M']//i[@class='academyicon icon-minus']")
	} )
			...
			for(String txt: str){
				if(txt != null && !txt.contains("Clear")){
					...
					if(txt != null && txt.contains(checkBoxIndex)){
						...
						clickOnButton(getfindElementByXPath(xpath));
						logger.debug("price check clicked.....");
						break;
					}
				}
	...
	public boolean clickAllPlusFilterOptions(){
	...
	public boolean checkAllfilterOptionsExpandedIsDisplayed(){
		if("mobile".equalsIgnoreCase(testtype)) {
	...
	public boolean clickAllMinusFilterOptions(){
		if("mobile".equalsIgnoreCase(testtype)) {
			boolean flag = false;
...
*/
	...
	public boolean checkboxProductCount(List<WebElement> facet_price_CheckBox_List){
		boolean flag = false;
		try{
			logger.debug("  ::__CheckBox_List Size:: "+facet_price_CheckBox_List.size());
			for(WebElement element: facet_price_CheckBox_List){
	...
	public int getFilterCheckBoxsProductCount(List<WebElement> facet_price_CheckBox_List){
		int productCount = 0;
		try{
			logger.debug("  ::__CheckBox_List Size:: "+facet_price_CheckBox_List.size());
			for(WebElement element: facet_price_CheckBox_List){
	...
	public int getFacetProductCount(WebElement facetProductCount){
		int productCount = 0;
		try{
	...
	public void deSelectMultiplePriceOption()  
	{
	...
	public boolean isPriceOptionDeSelected()  
	{
		boolean flag = false;
